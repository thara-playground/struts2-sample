 ...
 *
 */
public interface TimeChartLinePresenter {

	TimeChartLine getLine();
	
	/**
	 * @return the categoryPresenters
	 */
	List<TimeChartCategoryPresenter> getCategoryPresenters();

	/**
	 * @return the quentitiesPresenter
	 */
	TimeChartQuentitiesPresenter getQuentitiesPresenter();
}