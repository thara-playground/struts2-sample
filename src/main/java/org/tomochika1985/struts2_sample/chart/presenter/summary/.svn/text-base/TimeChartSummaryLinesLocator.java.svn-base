 ...
 *
 */
public interface TimeChartSummaryLinesLocator {

	List<TimeChartLinePresenter> lookup(CategoryCompositeKey groupingKey);

	public abstract void addSummaryLine(CategoryCompositeKey groupingKey, List<TimeChartLinePresenter> sources);
}
