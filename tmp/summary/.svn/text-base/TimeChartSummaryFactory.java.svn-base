 ...
 *
 */
public interface TimeChartSummaryFactory {

	PresentationListener createSummaryPresentationMediator();
	
	TimeChartLineSummarizer getSummarizer();
	
	void addSummary(TimeChartLine line, TimeChartLinePresenter linePresenter);
	
	void setupSummary(TimeChartPresenter presenter);
}
